...
exercises_data = [
    ...
    {"name": "面拉（Face Pull）", "video": "https://www.youtube.com/watch?v=89yerIMpGX4", "category": "背"}, # 針對後三角肌
    ...
    {"name": "坐姿小腿上提", "video": "https://www.youtube.com/watch?v=pcsg3Rlsz7w", "category": "腿"}
